...
<!-- badges: start -->
[![Travis build status](https://img.shields.io/travis/itsleeds/od/master?logo=travis&style=flat-square&label=Linux)](https://travis-ci.org/itsleeds/od)
...
[![R CMD Check via {tic}](https://github.com/robinlovelace/od/workflows/R%20CMD%20Check%20via%20{tic}/badge.svg?branch=master)](https://github.com/robinlovelace/od/actions)
